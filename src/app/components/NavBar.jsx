        ...
        <nav className="fixed top-0 left-0 right-0 z-10 bg-[#3e3e3e] bg-opacity-90 py-4 px-6">
            <div className="flex flex-wrap items-center justify-between mx-auto px-4 md:px-8">
                ...
                <div className="mobile-menu block md:hidden">
                    ...
                    {
                        !navbarOpen ? (
                            <button onClick={() => setnavbarOpen(true)} className="flex items-center px-3 py-3 border rounded border-slate-200 text-slate-200 hover:text-white">
                                <Bars3Icon className="h-5 w-5"/>
                            </button>
                        ) : (
                            <button onClick={() => setnavbarOpen(false)} className="flex items-center px-3 py-3 border rounded border-slate-200 text-slate-200 hover:text-white">
