            ...
            <section className="flex-grow flex flex-col md:flex-row items-center my-12 py-24 gap-8 px-6" style={{ paddingBottom: '150px' }}>
                <div className="flex-1 md:pr-6 md:pl-6">
                    ...
                    <div className="socials flex flex-row gap-4 relative z-10">
                        ...
                        <a href="mailto:josephmohanty8999@gmail.com" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-12 h-12 text-white">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 13.5h3.86a2.25 2.25 0 0 1 2.012 1.244l.256.512a2.25 2.25 0 0 0 2.013 1.244h3.218a2.25 2.25 0 0 0 2.013-1.244l.256-.512a2.25 2.25 0 0 1 2.013-1.244h3.859m-19.5.338V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 0 0-2.15-1.588H6.911a2.25 2.25 0 0 0-2.15 1.588L2.35 13.177a2.25 2.25 0 0 0-.1.661Z" />
                            </svg>
                        </a>

                        <a href="https://leetcode.com/u/josephmohanty8999/" target="_blank" rel="noopener noreferrer">
                            <Image
